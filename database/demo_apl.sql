...
INSERT INTO `players` (`id`,`tournament_id`,`full_name`,`display_name`,`country`,`role`,`batting_style`,`bowling_style`,`is_overseas`,`is_capped`,`auction_set`,`base_price`,`career_matches`,`career_runs`,`career_wickets`,`strike_rate`,`economy`,`status`,`team_id`,`sold_price`) VALUES
  ...
  (2,1,'Gaurav Ghosh','G Ghosh','India','bowling_all_rounder','right_hand','right_arm_offbreak',0,1,'Marquee',2000000.00,26,394,25,108.40,7.80,'sold',1,4000000.00),
  ...
  (6,1,'Rakesh Patel','R Patel','India','batting_all_rounder','right_hand','left_arm_orthodox',0,1,'Set A',1500000.00,38,582,45,115.20,8.00,'sold',1,3500000.00),
  ...
  (10,1,'Rahul Bose','R Bose','India','bowling_all_rounder','right_hand','right_arm_legbreak',0,1,'Set A',1500000.00,50,770,65,122.00,8.20,'sold',2,2000000.00),
  ...
  (14,1,'Keshav Menon','K Menon','India','batting_all_rounder','right_hand','right_arm_fast',0,1,'Set A',1500000.00,62,958,85,128.80,8.40,'sold',2,2000000.00),
  ...
  (18,1,'Rohan Kapoor','R Kapoor','India','bowling_all_rounder','right_hand','left_arm_fast',0,0,'Set B',1000000.00,74,1146,25,135.60,8.60,'sold',3,2000000.00),
  ...
  (22,1,'Eshan Iyer','E Iyer','India','batting_all_rounder','right_hand','right_arm_medium',0,0,'Set B',1000000.00,86,1334,45,142.40,8.80,'sold',4,2500000.00),
  ...
  (26,1,'Reyansh Chauhan','R Chauhan','India','bowling_all_rounder','right_hand','left_arm_medium',0,0,'Set B',1000000.00,98,1522,65,149.20,6.40,'sold',6,1500000.00),
  ...
  (30,1,'Abhay Sharma','A Sharma','India','batting_all_rounder','right_hand','right_arm_offbreak',0,0,'Set B',1000000.00,20,1710,85,156.00,6.60,'available',NULL,NULL),
  ...
  (34,1,'Suresh Pillai','S Pillai','India','bowling_all_rounder','right_hand','left_arm_orthodox',0,0,'Set C',500000.00,32,1898,25,107.80,6.80,'available',NULL,NULL),
  ...
  (38,1,'Tarun Aggarwal','T Aggarwal','India','batting_all_rounder','right_hand','right_arm_legbreak',0,0,'Set C',500000.00,44,2086,45,114.60,7.00,'available',NULL,NULL),
  ...
  (42,1,'Mahesh Shetty','M Shetty','India','bowling_all_rounder','right_hand','right_arm_fast',0,0,'Set C',500000.00,56,2274,65,121.40,7.20,'available',NULL,NULL),
  ...
  (46,1,'Omkar Yadav','O Yadav','India','batting_all_rounder','right_hand','left_arm_fast',0,0,'Set C',500000.00,68,2462,85,128.20,7.40,'available',NULL,NULL),
  ...
  (50,1,'Ganesh Desai','G Desai','India','bowling_all_rounder','right_hand','right_arm_medium',0,0,'Set D',200000.00,80,2650,25,135.00,7.60,'available',NULL,NULL),
  ...
  (54,1,'Kunal Pandey','K Pandey','India','batting_all_rounder','right_hand','left_arm_medium',0,0,'Set D',200000.00,92,2838,45,141.80,7.80,'available',NULL,NULL),
  ...
  (58,1,'Anand Rao','A Rao','India','bowling_all_rounder','right_hand','right_arm_offbreak',0,0,'Set D',200000.00,104,426,65,148.60,8.00,'available',NULL,NULL),
